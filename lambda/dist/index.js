...
const ask_weather_1 = require("./handlers/ask-weather");
...
exports.handler = ask_sdk_core_1.SkillBuilders.custom()
    .addRequestHandlers(launch_1.LaunchRequestHandler, ask_weather_1.AskWeatherIntentHandler, help_1.HelpIntentHandler, cancel_stop_1.CancelAndStopIntentHandler, end_sesion_1.SessionEndedRequestHandler)
